...
use anime_reviews;
create table anime_imdb_ratings(
title varchar(255),
genre varchar(255),
...
CREATE TABLE anime_imdb_ratings_1 (
  title TEXT,
  genre TEXT,
  user_rating TEXT,
...
load data local infile 'C:/Users/likhi/Downloads/archive/imdb_anime.csv'
into table anime_imdb_ratings_1
